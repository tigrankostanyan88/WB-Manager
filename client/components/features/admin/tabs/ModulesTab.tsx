...
import { Plus, Edit, Trash2, X, Upload, Film, Video, Clock, BookOpen, Check } from 'lucide-react'
import { useState } from 'react'
import type { ModuleItem, ModuleFile, CourseOption } from '@/components/features/admin/hooks/useModules'
import { formatDuration, formatMinutes, getVideoCount, getTotalVideoDuration } from '@/components/features/admin/hooks/useModules'
import { ModuleVideoThumbnail } from '@/components/features/admin/components/ModuleVideoThumbnail'
import { VideoPlayerModal } from '@/components/features/admin/components/VideoPlayerModal'
...
interface ModulesTabProps {
  ...
  setModuleForm: React.Dispatch<React.SetStateAction<ModuleForm>>
