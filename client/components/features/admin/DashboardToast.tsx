    ...
    <AnimatePresence>
      {toast && (
        <motion.button
          ...
          onClick={onClose}
          className={cn(
            'fixed top-20 right-5 z-[9999] max-w-[520px] px-4 py-2 rounded-xl shadow-lg flex items-center gap-2 border backdrop-blur-sm cursor-pointer active:scale-95 transition',
            toast.type === 'success'
