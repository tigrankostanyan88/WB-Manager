    ...
    <AnimatePresence>
      {toast && (
        <motion.button
          ...
          onClick={onClose}
          className={cn(
            'fixed top-20 right-6 z-[9999] px-5 py-3 rounded-2xl shadow-2xl flex items-center gap-3 backdrop-blur-xl border cursor-pointer active:scale-95 transition-all',
            toast.type === 'success'
