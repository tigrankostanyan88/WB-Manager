      ...
      <div className="container px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-primary text-primary-foreground shadow-2xl ring-1 ring-primary/30 px-4 sm:px-6 py-8 sm:py-12 md:px-10 md:py-16 text-center">
          ...
          <div className="relative mt-6 sm:mt-8 flex flex-col sm:flex-row justify-center gap-3 px-4 sm:px-0">
            <Button
              className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 rounded-full h-12 sm:h-11 px-4 sm:px-6 text-sm sm:text-base w-full sm:w-auto"
              size="lg"
              onClick={onOpenModal}
            >
              Սկսել հիմա
            ...
            <Button
              variant="outline"
              className="text-black border-primary-foreground/30 hover:bg-primary-foreground hover:text-primary rounded-full h-12 sm:h-11 px-4 sm:px-6 text-sm sm:text-base w-full sm:w-auto"
              size="lg"
            >
              Իմանալ ավելին
            </Button>
