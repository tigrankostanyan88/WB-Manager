        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] overflow-y-auto py-8">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl my-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900">Հաստատել ջնջումը</h3>
            </div>
            <p className="text-slate-600 mb-6">
              Վստա՞հ եք, որ ցանկանում եք ընդմիշտ ջնջել {selectedIds.size} օգտատիրոջը։
              <br /><span className="text-red-600 font-medium">Այս գործողությունը անվերադարձ է։</span>
            </p>
