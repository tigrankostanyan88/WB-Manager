...
import BankCardsTab from '@/components/features/admin/tabs/BankCardsTab'
import CoursesTab from '@/components/features/admin/tabs/CoursesTab'
import ModulesTab from '@/components/features/admin/tabs/ModulesTab'
import CommentsTab from '@/components/features/admin/tabs/CommentsTab'
import InstructorTab from '@/components/features/admin/tabs/InstructorTab'
